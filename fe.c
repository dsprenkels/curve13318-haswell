...
Set z = if (z > p)  z - p,
        otherwise   z
*/
void fe51_reduce(fe51 z)
{
    /*
    `fe51_carry` ensures that an element `z` is always in range [0, 2^256⟩.
    ...
    */
    ...
    // In constract to `fe51_carry`, this function needs to carry the elements
